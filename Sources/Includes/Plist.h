 ...
 */
	...
	#define kAppDarkMode				@"App Dark Mode"
	...
	#define	kWBCWPTTRelease				@"WBCW PTT Release"
	#define	kWBCWExtCWEnable			@"WBCW External CW Enable"
	#define	kWBCWExtCWDevice			@"WBCW External CW Device"
	#define	kWBCWExtCWLine				@"WBCW External CW Line"
	#define	kWBCWExtCWInvert			@"WBCW External CW Invert"
